...
private:
  ...
  bool get_transform_unlabeled_marker_msg(geometry_msgs::msg::TransformStamped &msg,
                         const rclcpp::Time &now, int idx);
  ...
  void create_unlabeled_markers_thread(int idx);
  void create_unlabeled_markers(int idx);
  void process_frame(rclcpp::Time &grab_time);
  void process_specific_segment(const rclcpp::Time &frame_time);
  void process_all_segments_and_unlabled_markers(const rclcpp::Time &frame_time);
  void process_all_segments(const rclcpp::Time &frame_time);
  void process_all_unlabeled_markers(const rclcpp::Time &frame_time);
